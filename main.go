...
func main() {
	...
	if targetURL == "" {
		...
		fmt.Fprintf(os.Stderr, "Usage: hadi-robo-finder [-v] [-h] [-year YYYY] <target-url>\n")
		fmt.Fprintf(os.Stderr, "Example: hadi-robo-finder -year 2020 https://example.com\n")
...
func printHelp() {
	...
	fmt.Println()
	fmt.Println("USAGE:")
	fmt.Println("  hadi-robo-finder [-v] [-h] [-year YYYY] <target-url>")
	fmt.Println()
	fmt.Println("OPTIONS:")
	...
	fmt.Println("    hadi-robo-finder https://example.com")
	fmt.Println()
	fmt.Println("  Verbose mode (see detailed progress):")
	fmt.Println("    hadi-robo-finder -v https://tesla.com")
	fmt.Println()
	fmt.Println("  Without protocol (auto-adds https://):")
	fmt.Println("    hadi-robo-finder example.com")
	fmt.Println()
	fmt.Println("  Save results to file:")
	fmt.Println("    hadi-robo-finder https://example.com > discovered_urls.txt")
	fmt.Println()
	fmt.Println("  Filter by year (snapshots from 2020 onwards):")
	fmt.Println("    hadi-robo-finder -year 2020 https://example.com")
	fmt.Println()
	fmt.Println("  Combine verbose mode with year filter:")
	fmt.Println("    hadi-robo-finder -v -year 2022 https://example.com")
	fmt.Println()
	fmt.Println("  Pipe to other tools:")
	fmt.Println("    hadi-robo-finder https://example.com | httpx -status-code")
	fmt.Println("    hadi-robo-finder https://example.com | grep '/api/' | nuclei")
	fmt.Println("    hadi-robo-finder -year 2023 https://target.com | httpx -mc 200")
	fmt.Println()
